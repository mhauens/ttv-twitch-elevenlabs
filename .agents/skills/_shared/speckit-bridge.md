...
- Wenn ein GitHub-Agent weitere Speckit-Agents als Handoff nennt, behandle das als Workflow-Hinweis. Spawne Codex-Subagents nur, wenn der User ausdruecklich Delegation moechte.
